...
const Hero = () => {
  return (
    <div className="-mt-54 z-20 relative max-w-[1200px] mx-auto flex flex-col md:flex-row gap-5 px-4 sm:px-6">
      {/* Countdown section */}
      <div className="flex-grow py-5 px-6 sm:px-10 rounded bg-stone-900">
        <Countdown
